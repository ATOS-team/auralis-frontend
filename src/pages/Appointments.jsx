                ...
                {viewMode === 'list' ? (
                    ...
                    >
                        ...
                        <div className="flex flex-col lg:flex-row gap-6 items-start">
                            ...
                            <div className="w-full lg:w-[240px] space-y-4 shrink-0 lg:sticky lg:top-8">
                                {/* Navigation Dashboard */}
                                <div className="glass-card rounded-[1.75rem] p-4 clinical-shadow border-white/40">
                                    <h3 className="text-[9px] font-black text-muted-foreground uppercase tracking-[0.2em] mb-4 px-2">Clinical Modules</h3>
                                    <div className="space-y-1">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    "w-full flex items-center gap-2.5 px-3 py-3 rounded-xl text-[9px] font-black uppercase tracking-[0.08em] transition-all group",
                                                    activeTab === link.id
                                                        ? "bg-primary text-white shadow-md shadow-primary/20"
                                                        : "text-slate-500 hover:bg-slate-50 hover:text-primary"
                                                )}
                                            >
                                                <link.icon className={cn("h-3.5 w-3.5 shrink-0", activeTab === link.id ? "text-white" : link.color)} />
                                                <span className="truncate">{link.id}</span>
                                                <ChevronRight className={cn("ml-auto h-3 w-3 opacity-0 group-hover:opacity-100 transition-all", activeTab === link.id && "opacity-100")} />
                                            </button>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="pt-1">
                                    <button className="w-full py-3 rounded-xl bg-primary text-white font-black text-[9px] uppercase tracking-widest hover:brightness-110 transition-all shadow-lg shadow-primary/20">
