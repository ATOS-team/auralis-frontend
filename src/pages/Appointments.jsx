            ...
            <AnimatePresence mode="wait">
                {viewMode === 'list' ? (
                    ...
                    >
                        ...
                        <div className="glass-card rounded-[2rem] md:rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden clinical-shadow">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-8 pb-4 border-b border-slate-100">
                            <div className="flex items-center gap-4 md:gap-6 lg:gap-8">
                                <button
                                    onClick={() => setViewMode('list')}
                                    className="p-3 md:p-4 lg:p-5 bg-white rounded-2xl md:rounded-3xl border-2 border-slate-100 hover:border-primary transition-all text-primary shadow-sm group shrink-0"
                                >
                                    <ArrowLeft className="h-5 w-5 md:h-6 md:w-6 lg:h-7 lg:w-7 group-hover:-translate-x-1 transition-transform" />
                                </button>
                                <div className="space-y-1">
                                    <div className="flex items-center gap-3 md:gap-4 lg:gap-5">
                                        <h2 className="text-3xl md:text-4xl lg:text-6xl font-black tracking-tighter text-slate-800">{patientData?.name || 'Loading Case...'}</h2>
                                    ...
                                    <div className="flex items-center gap-2 md:gap-3 lg:gap-4 text-[10px] md:text-xs lg:text-sm font-black uppercase tracking-[0.2em] text-muted-foreground shrink-0 overflow-hidden text-ellipsis whitespace-nowrap">
                                        ...
                                        <span className="w-1 md:w-1.5 lg:w-2 h-1 md:h-1.5 lg:h-2 bg-slate-300 rounded-full shrink-0" />
                        ...
                        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 mt-6 lg:mt-8 items-start">
                            ...
                            <div className="flex-1 w-full space-y-6 lg:space-y-8 min-w-0 overflow-hidden">
                                <div className="glass-card rounded-[2rem] md:rounded-[2.5rem] lg:rounded-[3rem] p-6 md:p-8 lg:p-10 clinical-shadow min-h-[680px] lg:min-h-[800px] flex flex-col">
                                    {activeTab === 'Charts' && (
                                        <div className="flex-1 space-y-10 lg:space-y-12">
                                            {/* BP Graph Terminal */}
                                            <div className="space-y-4 lg:space-y-6">
                                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                                    <h3 className="text-xl lg:text-3xl font-black text-slate-800 tracking-tight flex items-center gap-2 lg:gap-3">
                                                        <Activity className="h-5 w-5 lg:h-7 lg:w-7 text-rose-500" /> Blood Pressure Synthesis
                                                    </h3>
                                                    <div className="flex gap-4 text-[10px] lg:text-xs font-black uppercase tracking-widest bg-slate-100/50 px-4 py-2 rounded-full hidden md:flex">
                                            ...
                                            <div className="space-y-4 lg:space-y-6">
                                                <h3 className="text-xl lg:text-3xl font-black text-slate-800 tracking-tight flex items-center gap-2 lg:gap-3">
                                                    <Heart className="h-5 w-5 lg:h-7 lg:w-7 text-rose-500 animate-pulse" /> Cardiac Pulse Wave
                                                </h3>
                                                <div className="h-[200px] md:h-[280px] lg:h-[350px] w-full">
                                                    <ResponsiveContainer width="100%" height="100%">
                                        ...
                                        <div className="space-y-6 lg:space-y-8 h-full flex flex-col">
                                            <div className="flex justify-between items-center">
                                                <div className="flex items-center gap-4 lg:gap-6">
                                                    <h3 className="text-2xl lg:text-4xl font-black text-slate-800 tracking-tight">Physiological Log</h3>
                                                    <div className="flex items-center gap-1 lg:gap-2 bg-slate-100 p-1 lg:p-1.5 rounded-xl lg:rounded-2xl border border-slate-200">
                                                        <button
                                                ...
                                                <AnimatePresence mode="wait">
                                                    {vitalsTabMode === 'list' ? (
                                                        ...
                                                        <motion.div
                                                            ...
                                                            animate={{ opacity: 1, x: 0 }}
                                                            exit={{ opacity: 0, x: -10 }}
                                                            className="h-[300px] md:h-[500px] w-full bg-slate-50/50 rounded-[2rem] p-4 md:p-8 border border-slate-100"
                                                        >
...
const VitalsModal = ({ visible, onClose, patientId, onRefresh }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} className="relative bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl p-6 md:p-10 w-full max-w-2xl border border-white/50 overflow-y-auto no-scrollbar h-[95vh] md:max-h-[90vh]">
                <h3 className="text-2xl md:text-3xl font-black tracking-tight text-slate-800 mb-6 md:mb-8">Deploy Vitals Update</h3>
...
const DiagnosisModal = ({ visible, onClose, patientId, onRefresh }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="absolute inset-0 bg-slate-900/60 backdrop-blur-md" onClick={onClose} />
            <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} className="relative bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl p-6 md:p-10 w-full max-w-2xl border border-white/50 overflow-y-auto no-scrollbar h-[95vh] md:max-h-[90vh]">
                <h3 className="text-2xl md:text-3xl font-black tracking-tight text-slate-800 mb-6 md:mb-8">Add New Diagnosis</h3>
...
const BillModal = ({ visible, onClose, patientId, onRefresh }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="absolute inset-0 bg-slate-900/60 backdrop-blur-md" onClick={onClose} />
            <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} className="relative bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl p-6 md:p-10 w-full max-w-lg border border-white/50">
                <h3 className="text-2xl md:text-3xl font-black tracking-tight text-slate-800 mb-6 md:mb-8">Generate Service Bill</h3>
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
...
const HistoryModal = ({ visible, onClose, patientId, initialData, onRefresh }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="absolute inset-0 bg-slate-900/60 backdrop-blur-md" onClick={onClose} />
            <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} className="relative bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl p-6 md:p-10 w-full max-w-lg border border-white/50">
                <h3 className="text-2xl md:text-3xl font-black tracking-tight text-slate-800 mb-6 md:mb-8">Update Medical Vault</h3>
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
