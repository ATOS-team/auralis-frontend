                    ...
                    {Object.entries(groupedEvents).map(([dateLabel, dateEvents], groupIdx) => (
                        <div key={dateLabel} className="space-y-12 relative">
                            ...
                            <div className="flex items-center justify-center relative z-20">
                                <div className="px-6 py-2 bg-indigo-50 border-2 border-indigo-100 rounded-full font-black text-xs uppercase tracking-widest text-indigo-600 shadow-sm">
                                    {dateLabel}
                                </div>
                            </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="ml-16 md:ml-0 w-full md:w-[45%]">
                                            <div className="glass-card rounded-[2.5rem] p-6 md:p-8 clinical-shadow border-white/40 hover:scale-[1.02] transition-all duration-500 group relative overflow-hidden">
                                                {/* Type Badge */}
                                                <div className={cn(
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    {event.type === 'Vitals' && (
                                                        <div className="grid grid-cols-4 gap-2 pt-4 border-t border-slate-100">
                                                            <div><p className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase">BP</p><p className="text-[10px] md:text-xs font-black text-primary">{event.details.sbp}/{event.details.dbp || 80}</p></div>
                                                    ...
                                                    {event.type === 'Diagnosis' && event.details.prescription && (
                                                        <div className="bg-indigo-50/50 p-3 md:p-4 rounded-2xl border border-indigo-100 hidden md:block">
                                                            ...
                                                            <p className="text-xs font-bold text-slate-700 truncate line-clamp-2 md:whitespace-normal">{event.details.prescription}</p>
                                                        </div>
                                                    )}
                                                    ...
                                                    {event.type === 'Billing' && (
                                                        <div className="flex justify-between items-center pt-4 border-t border-slate-100">
                                                            ...
                                                            <p className="text-base md:text-lg font-black text-slate-800 tracking-tighter">₹{event.details.total_cost}</p>
                                                        </div>
                                                    )}

                                                    <div className="absolute bottom-4 right-6 text-[8px] font-black text-slate-300 uppercase tracking-widest flex items-center gap-2">
