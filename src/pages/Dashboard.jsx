...
const StatCard = ({ title, value, label, icon: Icon, trend, color, delay }) => (
    <motion.div
        ...
        className="glass-card p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] clinical-shadow relative overflow-hidden group hover:scale-105 transition-all duration-500"
    >
        ...
        <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-black text-foreground tracking-tighter mb-2">{value}</h3>
            <p className="text-sm md:text-base font-bold text-muted-foreground uppercase tracking-wider">{title}</p>
            {label && <p className="text-[10px] md:text-xs font-bold text-muted-foreground mt-3 opacity-60 uppercase tracking-widest">{label}</p>}
        </div>
    </motion.div>
);
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative bg-white/90 backdrop-blur-2xl rounded-2xl md:rounded-[3rem] shadow-2xl w-full max-w-4xl h-[95vh] md:h-auto md:max-h-[90vh] overflow-hidden flex flex-col border border-white/50"
            >
                <div className="p-6 md:p-10 flex-1 overflow-y-auto no-scrollbar">
                    <div className="flex justify-between items-start mb-6 md:mb-10">
                        <div>
                            <span className="px-4 md:px-5 py-1.5 md:py-2 rounded-full bg-indigo-50 text-indigo-600 font-black text-[10px] md:text-xs lg:text-sm uppercase tracking-widest border border-indigo-100 mb-4 inline-block">
                                Clinical Session Management
                            </span>
                            <h2 className="text-2xl md:text-4xl lg:text-6xl font-black tracking-tighter text-foreground">Manage Appointment</h2>
                        </div>
                        <button onClick={onClose} className="p-2 md:p-4 rounded-2xl hover:bg-slate-100 transition-all text-slate-400">
                ...
                <div className="p-6 md:p-10 bg-slate-50/50 backdrop-blur-sm border-t border-white/50 grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                    <button
                        onClick={() => handleAction('Approved')}
                        disabled={isSaving}
                        className="py-3 md:py-5 bg-indigo-600 text-white rounded-xl md:rounded-2xl font-black text-[10px] md:text-sm uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-xl flex items-center justify-center gap-2"
                    >
        ...
        <div className="space-y-8 pb-10">
            <div className="flex items-center justify-between gap-6 mb-10">
                <div>
                    <div className="flex items-center gap-3 md:gap-4 mb-2 md:mb-3">
                        <div className="p-2 md:p-3 bg-primary text-white rounded-xl md:rounded-2xl shadow-lg ring-4 ring-primary/10">
                            <Activity className="h-5 w-5 md:h-6 md:w-6 lg:h-8 lg:w-8" />
                        </div>
                        <h1 className="text-3xl md:text-5xl lg:text-7xl font-black tracking-tighter text-foreground">
                            Hospital Analytics <span className="text-primary block sm:inline">Dashboard</span>
                        </h1>
                    </div>
                    <p className="text-sm md:text-xl lg:text-3xl text-muted-foreground font-bold italic tracking-tight">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div className="lg:col-span-3">
                    <div className="glass-card rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 border-white/40 clinical-shadow bg-white/40 backdrop-blur-3xl overflow-hidden relative">
                        <div className="absolute top-0 right-0 p-10 opacity-5">
                            <Activity className="h-64 w-64 text-primary" />
                        </div>
                        <div className="relative z-10 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 mb-10">
                            <div>
                                <h4 className="text-xs md:text-sm lg:text-base font-black text-primary uppercase tracking-[0.3em] mb-2 lg:mb-4">Real-time Admission Trends</h4>
                                <h3 className="text-2xl md:text-3xl lg:text-5xl font-black tracking-tight">Ward Occupancy Matrix</h3>
                            </div>
                ...
                <div className="space-y-6">
                    <div className="glass-card p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] clinical-shadow border-white/40 bg-gradient-to-br from-indigo-900 to-slate-900 text-white">
                        <h4 className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] opacity-60 mb-6">Demographic Synthesis</h4>
                        <div className="space-y-6">
                            {[
            ...
            {user?.role === 'Doctor' && (
                <div className="mt-16 space-y-8">
                    <div className="flex items-center justify-between">
                        <h3 className="text-3xl lg:text-5xl font-black tracking-tight flex items-center gap-4">
                            <Calendar className="h-10 w-10 lg:h-12 lg:w-12 text-primary" /> Patient Load Matrix
                        </h3>
                        <div className="flex items-center gap-2 px-6 py-2 bg-indigo-50 text-indigo-600 rounded-full font-black text-sm lg:text-base uppercase tracking-widest shadow-sm border border-indigo-100">
                            <Info className="h-4 w-4 lg:h-5 lg:w-5" /> Physician-Only Management
                        </div>
                    </div>
